...
toGray | [图片灰度化](python/code_002/opencv_002.py)   | ✔️
...
pixelValueStatistics | [图像像素值统计](python/code_010/opencv_010.py)   | ✔️
code_011 | [图像像素归一化](python/code_011/opencv_011.py)   | ✔️
code_012 | [视频读写](python/code_012/opencv_012.py)   | ✔️
xFlip yFlip | [图像翻转](python/code_013/opencv_013.py)   | ✔️
...
sobelFilters | [Sobel算子](python/code_031/opencv_031.py)   | ✔️
...
cannyFilters | [Canny边缘检测器](python/code_036/opencv_036.py)   | ❣️
...
detectImage | [DNN- SSD单张图片检测](python/code_124)   | ✔️
